...
const App = () => {
  ...
  const logout = () => {
    ...
    // Redirect to custom logout endpoint that handles full logout flow
    window.location.href = `${BFF_URL}/api/logout?callbackUrl=${encodeURIComponent(window.location.origin)}`;
  };
