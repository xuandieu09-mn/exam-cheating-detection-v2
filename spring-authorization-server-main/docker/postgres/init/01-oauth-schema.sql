...
-- Pre-seed OAuth2 client for BFF Gateway
-- This ensures Docker deployments work out of the box
-- Note: Authorization Server's RegisteredClientSeeder will create clients if they don't exist
