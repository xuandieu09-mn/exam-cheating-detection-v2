...
public class RegisteredClientSeeder {
    ...
    private void seedConfidentialClient(RegisteredClientRepository repository,
        ...
        // Extract base URL from redirect URI (e.g., http://localhost:8080/api/auth/callback/... -> http://localhost:8080)
        String baseUrl;
        try {
        ...
        // For BFF, logout should redirect to React client, not BFF itself
