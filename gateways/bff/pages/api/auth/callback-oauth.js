...
export default async function handler(req, res) {
    ...
    try {
        ...
        const bffCallbackUri = `${process.env.NEXTAUTH_URL || 'http://localhost:8080'}/api/auth/callback-oauth`;
        ...
        res.setHeader('Set-Cookie', [
            `bff_session=${encodeURIComponent(sessionJson)}; Path=/; HttpOnly; SameSite=Lax; Max-Age=${tokens.expires_in || 3600}`,
